...
* [model_demo.ipynb](notebooks/model_demo.ipynb) walks you through the process of building and training a SynergyGT model and evaluating its performance.
* [model_exploration.ipynb](notebooks/model_exploration.ipynb) lets you interact with a trained SynergyGT model and test it on any gene or gene pair of interest.
...
## Contact
This project was developed in the [Levine Lab for Systems Bioengineering](https://levine-lab.sites.northeastern.edu/) at Northeastern University. For questions regarding the model or its repository, please open an issue or reach out via [email](bradleybuchner1@gmail.com) or [LinkedIn](https://www.linkedin.com/in/bradley-buchner/).
